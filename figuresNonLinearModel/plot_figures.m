...
colormap([colorRed; colorBlue]);
    ...
    figMandateEqPrices = figure;
        ...
        % Equilibrium
        % Plot prices
            plot(xGrid(2,end), Interval.pEquilibrium(2,end), 'k', 'linewidth', 3); %%% Change this line if mandate eliminate other options
            hold on;
            plot(xGrid(1),0,'k')
        ...
        % Plot prices
            ...
            hold on;
        % Plot average loss parameter
            scatter(xGrid, meanLossMandate, max(1, DMandate.*3600)*0.85, ...
